...
public class TechGUI : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        worldScript.GetComponent<VoxelMap>().fillTypeIndex = afillTypeIndex;
        worldScript.GetComponent<VoxelMap>().radiusIndex = aradiusIndex;
        worldScript.GetComponent<VoxelMap>().stencilIndex = astencilIndex;
    }
